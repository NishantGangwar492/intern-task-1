            ...
            <div className="row">
                <div className="col-1-of-2">
                    <h1 className="heading-primary">
                        <span className="heading-primary-main">Don't worry.</span>
                        <span className="heading-primary-sub">We are here for</span>
                        <span className="heading-primary-sub-2">every solution.</span>
                    </h1>
